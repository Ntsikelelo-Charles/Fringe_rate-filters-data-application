...
gsm_sky.write_hdf5(path_data+'Single_time_gsm2016_nside'+str(nside)+'.hdf5', clobber=True)
...
gleam.write_hdf5(path_data+'Single_time_gleam_nside'+str(nside)+'.hdf5', clobber=True)
...
#get metadata 
for i in range (N):
    Model_complete_file =uvh5name[i]
    uvd1 = UVData()
    uvd1.read(Model_complete_file, read_data=False)  
...
#create antenna file
with open('Single_time_HERA_test_layout.csv', 'w') as f:
...
uvd = healvis.simulator.setup_uvdata(array_layout="Single_time_HERA_test_layout.csv",
...
uvd.write_uvh5(path_data+"Single_time_diffuse_model_final.uvh5", clobber=True)
uvd.write_uvh5(path_data+"Single_time_gleam_model_final.uvh5", clobber=True)
...
# get data files
uvd_file_gleam = path_data+"Single_time_gleam_model_final.uvh5"
uvd_file_diffuse = path_data+"Single_time_diffuse_model_final.uvh5"
# get sky files
sky_file_diffuse = path_data+'Single_time_gsm2016_nside'+str(nside)+'.hdf5'
sky_file_gleam = path_data+'Single_time_gleam_nside'+str(nside)+'.hdf5'
